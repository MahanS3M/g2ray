# Create and run script in one go
cat > download-yt-to-repo.sh << 'EOF'
#!/bin/bash
...
# Make executable
chmod +x download-yt-to-repo.sh

# Run it (replace with your actual YouTube URL)
./download-yt-to-repo.sh "https://www.youtube.com/watch?v=YOUR_VIDEO_ID"